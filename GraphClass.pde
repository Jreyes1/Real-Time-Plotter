...
/*   =================================================================================       
  ...
  //    int Peakcounter=0,nPeakcounter=0;
      ...
      // Constructor for real time plotter use
      Graph(int x, int y, int w, int h,color k, String title, String xLabel,String yLabel, int numVariables,String[] variableLabels) {  
        xPos = x;
        yPos = y;
        Width = w;
        Height = h;
